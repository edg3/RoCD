...
/// <summary>
/// Obtained from https://lotsacode.wordpress.com/2010/02/24/perlin-noise-in-c/
/// </summary>
...
*/
    ...
    public class PerlinNoise
    {
        ...
        /// 1/width
        /// </summary>
        public static double widthDivisor { get; set; }
        /// <summary>
        /// 1/height
        /// </summary>
        public static double heightDivisor { get; set; }

        public static double TripleOctave(PerlinNoise perlinNoise, Point point)
        {
            //System.Console.WriteLine(((perlinNoise.Noise(2 * point.X * widthDivisor, 2 * point.Y * heightDivisor, -0.5) + 1) / 2 * 0.7 +
            //       // Second octave
            //       (perlinNoise.Noise(4 * point.X * widthDivisor, 4 * point.Y * heightDivisor, 0) + 1) / 2 * 0.2 +
            //       // Third octave
            //       (perlinNoise.Noise(8 * point.X * widthDivisor, 8 * point.Y * heightDivisor, +0.5) + 1) / 2 * 0.1).ToString());
            
                    // First octave
            return (perlinNoise.Noise(2 * point.X * widthDivisor, 2 * point.Y * heightDivisor, -0.5) + 1) / 2 * 0.7 +
                   // Second octave
                   (perlinNoise.Noise(4 * point.X * widthDivisor, 4 * point.Y * heightDivisor, 0) + 1) / 2 * 0.2 +
                   // Third octave
