    ...
    public class PassiveEnemyAgent : IAIAgent
    {
        ...
        public void RunAI(Actor _agent_on, Helpers.Tiles.Map _map, Actor _target)
        {
            if (agressive)
            {
                ...
                {
                    CombatLog.Log("PassiveEnemyAgent: agressive, close enough to attack player.");
                    //Attack target!
            ...
            else
            {
                ...
                {
                    CombatLog.Log("PassiveEnemyAgent: decided too far from player, time to die.");
                ...
                {
                    CombatLog.Log("PassiveEnemyAgent: I will roam.");
